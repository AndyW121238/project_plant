  ...
  <div class="login-container">
    ...
    >
      <div class="title-container">
        <h3 class="title" style="color: #fff">注册</h3>
      </div>
      ...
      <!--  <el-form-item prop="username">
        ...
        <el-input ref="username" v-model="loginForm.nickname" placeholder="昵称" name="nickname" type="text" tabindex="1" auto-complete="on" />
      </el-form-item> -->

      <el-button :loading="loading" type="infor" style="width: 100%; margin-bottom: 30px" @click.native.prevent="register">注册</el-button>
    </el-form>
  ...
  methods: {
    ...
    async handleLogin() {
      ...
      if (
        ...
        sessionStorage.setItem('name', this.loginUser.user)
