<template>
  <div class="dashboard-container">
    <el-form ref="searchForm" :model="searchForm" inline size="medium" class="searchForm" label-width="80px">
      ...
      <span style="margin-right: 100px;">用户列表</span>
      <el-button icon="el-icon-plus" plain @click="showDialog = true">新增</el-button>
      </el-form-item>
    </el-form>
    ...
    <!-- 增加编辑 -->
    <Dialog :show-dialog.sync="showDialog" title="" :append-body="true" width="500" @cancal="close" @confirm="confirm">
      <div slot>
