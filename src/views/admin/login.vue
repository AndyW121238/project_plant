<template>
  <div class="login-container">
    ...
    <el-form v-if="type=='登录'" ref="loginForm" :model="loginForm" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-link type="primary" :underline="false" style="margin-right:10px;" @click="register">注册</el-link>
    </el-form>
